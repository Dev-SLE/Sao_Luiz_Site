...
CREATE TABLE "tb_fin_centro_custo" (
	...
	"conta_despesa" text,
	"lcto_contabil" double precision,
	"codigo_externo" text,
	"centro_custo_codigo" text,
	"centro_custo_nivel" bigint,
	"tipo_descricao" text,
	"descricao_limpa" text,
	"etl_loaded_at" timestamp with time zone
);
CREATE TABLE "tb_fin_convenios" (
	"id_convenio" bigint,
	"banco" bigint,
	"agencia" bigint,
	"codigo_cedente" double precision,
	"carteira" double precision,
	"aceite" text,
	...
	"dv_agencia" text,
	"tipo" bigint,
	"id_estabelecimento" double precision,
	"situacao" bigint,
	"conta_compl" text,
	"multa" double precision,
	"emite_boleto" bigint,
	"cnpj_transferencia" text,
	"fazpagamentoeletronico" bigint,
	"diretorio_pagfor" text,
	"convenio_pagfor" text,
	"instr_12" text,
	"taxa_credito" text,
	"taxa_debito" text,
	"enviado" bigint,
	"complemento_multa" double precision,
	"bloquear_liquidacao_sem_saldo" double precision,
	"tipo_mora" double precision,
	"banco_str" text,
	"agencia_str" text,
	"convenio_pix" text,
	"nome_banco" text,
	...
	"id_cidade" text,
	"chave_pix_psp" text,
	"tipo_chave_pix_psp" text,
	"use_bolecode" text,
	"conta_limpa" text,
	"nome_banco_limpo" text,
	"tipo_convenio" text,
	"etl_loaded_at" timestamp with time zone
);
CREATE TABLE "tb_fin_faturas" (
	"id_fatura" bigint,
	"id_cliente" bigint,
	"data_ft" timestamp,
	"total_ft" double precision,
	"obs" text,
	"desconto_ft" double precision,
	"condicoes_ft" text,
	"data_desconto" timestamp,
	"situacao" bigint,
	"id_operador" bigint,
	"tipo" text,
	"acrescimo_ft" double precision,
	"documento" text,
	"perc_desconto_icms" double precision,
	"numero" bigint,
	"id_estabelecimento" bigint,
...
CREATE TABLE "tb_fin_obrigacoes" (
	"id_centro_custo" text,
	"id_obrigacao" bigint,
	"data_lcto" timestamp,
	"tipo_lcto" text,
	"id_natureza" double precision,
	"historico" text,
	...
	"tipo_liquidacao" double precision,
	"chave_cf" text,
	"id_contrato" text,
	"id_obr_vinculada" text,
	"local_promissoria" bigint,
	"data_promissoria" timestamp,
	"id_item_livro" double precision,
	"conta" text,
	"id_convenio" double precision,
	"documento" text,
	"id_retencao" text,
	"compor_livro" text,
	"desconto" double precision,
	"despesas_bancarias" double precision,
	"previsao" double precision,
	"id_nf_saidas" double precision,
	"id_estabelecimento" bigint,
	"baixa_livro" double precision,
	"origem_lcto" bigint,
	"nat_juros" double precision,
	"nat_multa" double precision,
	"id_pagfor" text,
	"data_pre" timestamp,
	"numero_nf" double precision,
	"origem_obr" double precision,
	"exportado" text,
	"id_lote_contabil" text,
	"hist_complementar" text,
	"data_emissao" timestamp,
	"id_obr_origem" double precision,
	"id_bordero" double precision,
	"nat_tarifa" double precision,
	"data_previsao" timestamp,
	"id_aprovador" text,
	"taxa_cartao" double precision,
	"tipo_lctocpcr" double precision,
	"tipo_documento" double precision,
	"regime_competencia" double precision,
	"guid_obrigacao" text,
	"situacao_pagfor" text,
	"id_veiculo" text,
	"cgccpf_ipvadpvat" text,
	"opcaopgto_ipvadpvat" text,
	"anoexe_ipvadpvat" text,
	"nome_contribuinte" text,
	"banco_str" text,
	"agencia_str" text,
	"nif" text,
	"id_cartao_credito" text,
	"nivel_aprovador" text,
	"id_obrigacao_origem" text,
	"email_enviado" text,
	"nat_rendi_reinf" text,
	"valor_bruto_reinf" double precision,
	"valor_tribut_reinf" text,
	"valor_irrf_reinf" text,
	"valor_iss_reinf" text,
	"valor_inss_reinf" text,
	"valor_pis_reinf" text,
	"valor_cssl_reinf" text,
	"valor_cofins_reinf" text,
	"retencao_atualizada" text,
	"idpgtonf" double precision,
	"id_ofx" text,
	"codigo_barra" text,
	"motivo_cancelamento" text,
	"emv_pix" text,
	"cod_erro_pix" text,
	"id_indenizacao_wscan" text,
	"mes_competencia" text,
	"ano_competencia" text,
	"contrato_clifor" text,
	"aliq_ibs_uf" double precision,
	"valor_ibs_uf" double precision,
	"perc_red_aliq_ibs_uf" double precision,
	"aliq_efet_ibs_uf" double precision,
	"aliq_ibs_mun" double precision,
	"valor_ibs_mun" double precision,
	"perc_red_aliq_ibs_mun" double precision,
	"aliq_efet_ibs_mun" double precision,
	"aliq_cbs" double precision,
	"valor_cbs" double precision,
	"perc_red_aliq_cbs" double precision,
	"aliq_efet_cbs" double precision,
	"cclass_trib" text,
	"base_calculo_ibscbs" double precision,
	"cartao_credito" double precision,
	"valor_principal" double precision,
	"valor_juros_calc" double precision,
	"valor_multa_calc" double precision,
	"valor_desconto_calc" double precision,
	"valor_despesas_bancarias_calc" double precision,
	"valor_total_calculado" double precision,
	"foi_liquidado" boolean,
	"esta_vencido" boolean,
	"tipo_parte" text,
	"status_financeiro" text,
	"etl_loaded_at" timestamp with time zone
);
CREATE TABLE "tb_fin_transferencias" (
	...
	"historico" text,
	"id_convenio_orig" bigint,
	"id_convenio_dest" bigint,
	"id_livro_caixa" bigint,
	"situacao" bigint,
	"data_conciliacao" timestamp,
	"documento" text,
	"id_pagfor" double precision,
	"exportado" text,
	"id_lote_contabil" double precision,
	"tipo" bigint,
	"tipo_transferencia" bigint,
	"enviado" text,
	"tipo_lcto" text,
	"id_controle_cartao" text,
	"id_natureza_orig" text,
	"id_natureza_dest" text,
	"transf_manual" text,
	"id_natureza" text,
	"vencimento" timestamp,
	...
	"conta_origem" text,
	"conta_destino" text,
	"historico_limpo" text,
	"valor_transferencia" double precision,
	"grupo_fluxo" text,
...
CREATE VIEW "bi"."vw_fin_faturamento_mensal" TABLESPACE bi AS (SELECT date_trunc('month'::text, data_ft)::date AS mes_referencia, sum(COALESCE(valor_fatura, 0::double precision)) AS valor_fatura, sum(COALESCE(valor_desconto, 0::double precision)) AS valor_desconto, sum(COALESCE(valor_acrescimo, 0::double precision)) AS valor_acrescimo, sum(COALESCE(valor_final, 0::double precision)) AS valor_final, count(*) AS qtd_faturas FROM bi.vw_fin_faturas WHERE data_ft IS NOT NULL GROUP BY (date_trunc('month'::text, data_ft)::date) ORDER BY (date_trunc('month'::text, data_ft)::date));
CREATE VIEW "bi"."vw_fin_faturas" TABLESPACE bi AS (SELECT id_fatura, id_cliente, data_ft, data_desconto, numero, obs, valor_fatura, valor_desconto, valor_acrescimo, valor_final, status_fatura, etl_loaded_at FROM tb_fin_faturas);
CREATE VIEW "bi"."vw_fin_obrigacoes" TABLESPACE bi AS (SELECT o.id_obrigacao, o.id_centro_custo, cc.centro_custo_codigo, cc.descricao_limpa AS centro_custo_descricao, cc.tipo_descricao AS centro_custo_tipo, o.id_clifor, o.tipo_parte, o.id_convenio, o.id_estabelecimento, o.data_lcto, o.data_emissao, o.vencimento, o.data_liquidacao, o.historico, o.hist_complementar, o.documento, o.banco, o.agencia, o.conta, o.valor_principal, o.valor_juros_calc, o.valor_multa_calc, o.valor_desconto_calc, o.valor_despesas_bancarias_calc, o.valor_total_calculado, o.valor_liquidado, o.foi_liquidado, o.esta_vencido, CASE WHEN o.data_liquidacao IS NOT NULL OR o.foi_liquidado IS TRUE THEN 'liquidado'::text WHEN o.vencimento IS NULL THEN 'sem_vencimento'::text WHEN o.esta_vencido IS TRUE THEN 'vencido'::text ELSE 'em_aberto'::text END AS status_financeiro, o.etl_loaded_at FROM tb_fin_obrigacoes o LEFT JOIN tb_fin_centro_custo cc ON COALESCE(NULLIF(TRIM(BOTH FROM o.id_centro_custo), ''::text), 'SEM_CENTRO'::text) = COALESCE(NULLIF(TRIM(BOTH FROM cc.centro_custo_codigo), ''::text), 'SEM_CENTRO'::text));
CREATE VIEW "bi"."vw_fin_obrigacoes_validas" TABLESPACE bi AS (SELECT id_obrigacao, id_centro_custo, centro_custo_codigo, centro_custo_descricao, centro_custo_tipo, id_clifor, tipo_parte, id_convenio, id_estabelecimento, data_lcto, data_emissao, vencimento, data_liquidacao, historico, hist_complementar, documento, banco, agencia, conta, valor_principal, valor_juros_calc, valor_multa_calc, valor_desconto_calc, valor_despesas_bancarias_calc, valor_total_calculado, valor_liquidado, foi_liquidado, esta_vencido, status_financeiro, etl_loaded_at FROM bi.vw_fin_obrigacoes WHERE COALESCE(vencimento, data_lcto, data_emissao) IS NOT NULL AND COALESCE(vencimento, data_lcto, data_emissao) >= '2024-01-01'::date AND COALESCE(vencimento, data_lcto, data_emissao) < '2031-01-01'::date);
CREATE VIEW "bi"."vw_fin_por_centro_custo" TABLESPACE bi AS (SELECT COALESCE(centro_custo_codigo, 'SEM_CENTRO'::text) AS centro_custo_codigo, COALESCE(centro_custo_descricao, 'SEM_CENTRO'::text) AS centro_custo_descricao, sum(COALESCE(valor_total_calculado, 0::double precision)) AS valor_total, sum(COALESCE(valor_liquidado, 0::double precision)) AS valor_liquidado, sum( CASE WHEN foi_liquidado IS TRUE THEN 0::double precision ELSE COALESCE(valor_total_calculado, 0::double precision) END) AS valor_em_aberto, sum( CASE WHEN esta_vencido IS TRUE THEN COALESCE(valor_total_calculado, 0::double precision) ELSE 0::double precision END) AS valor_vencido, count(*) AS qtd_titulos FROM bi.vw_fin_obrigacoes GROUP BY (COALESCE(centro_custo_codigo, 'SEM_CENTRO'::text)), (COALESCE(centro_custo_descricao, 'SEM_CENTRO'::text)) ORDER BY (sum(COALESCE(valor_total_calculado, 0::double precision))) DESC);
CREATE VIEW "bi"."vw_fin_resumo_geral" TABLESPACE bi AS (SELECT date_trunc('month'::text, data_ref)::date AS mes_referencia, round(sum(valor_em_aberto)::numeric, 2) AS total_em_aberto, round(sum(valor_liquidado_calc)::numeric, 2) AS total_liquidado, round(sum(valor_vencido)::numeric, 2) AS total_vencido, count(*) AS qtd_registros FROM ( SELECT COALESCE(vw_fin_obrigacoes.vencimento, vw_fin_obrigacoes.data_lcto, vw_fin_obrigacoes.data_emissao) AS data_ref, CASE WHEN vw_fin_obrigacoes.foi_liquidado IS TRUE THEN 0::double precision ELSE COALESCE(vw_fin_obrigacoes.valor_total_calculado, 0::double precision) END AS valor_em_aberto, COALESCE(vw_fin_obrigacoes.valor_liquidado, 0::double precision) AS valor_liquidado_calc, CASE WHEN vw_fin_obrigacoes.esta_vencido IS TRUE THEN COALESCE(vw_fin_obrigacoes.valor_total_calculado, 0::double precision) ELSE 0::double precision END AS valor_vencido FROM bi.vw_fin_obrigacoes) x WHERE data_ref IS NOT NULL AND data_ref >= '2024-01-01'::date AND data_ref < '2031-01-01'::date GROUP BY (date_trunc('month'::text, data_ref)::date) ORDER BY (date_trunc('month'::text, data_ref)::date));
...
CREATE VIEW "bi"."vw_tesouraria_historicos" TABLESPACE bi AS (SELECT COALESCE(grupo_fluxo, 'outros'::text) AS grupo_fluxo, round(sum(valor_transferencia)::numeric, 2) AS valor_total, count(*) AS qtd_transferencias FROM bi.vw_tesouraria_transferencias GROUP BY (COALESCE(grupo_fluxo, 'outros'::text)) ORDER BY (round(sum(valor_transferencia)::numeric, 2)) DESC);
CREATE VIEW "bi"."vw_tesouraria_por_destino" TABLESPACE bi AS (SELECT COALESCE(conta_destino, 'SEM_CONTA_DESTINO'::text) AS conta_destino, COALESCE(nome_banco_destino, 'SEM_BANCO_DESTINO'::text) AS banco_destino, round(sum(valor_transferencia)::numeric, 2) AS valor_total, count(*) AS qtd_transferencias FROM bi.vw_tesouraria_transferencias GROUP BY (COALESCE(conta_destino, 'SEM_CONTA_DESTINO'::text)), (COALESCE(nome_banco_destino, 'SEM_BANCO_DESTINO'::text)) ORDER BY (round(sum(valor_transferencia)::numeric, 2)) DESC);
CREATE VIEW "bi"."vw_tesouraria_por_origem" TABLESPACE bi AS (SELECT COALESCE(conta_origem, 'SEM_CONTA_ORIGEM'::text) AS conta_origem, COALESCE(nome_banco_origem, 'SEM_BANCO_ORIGEM'::text) AS banco_origem, round(sum(valor_transferencia)::numeric, 2) AS valor_total, count(*) AS qtd_transferencias FROM bi.vw_tesouraria_transferencias GROUP BY (COALESCE(conta_origem, 'SEM_CONTA_ORIGEM'::text)), (COALESCE(nome_banco_origem, 'SEM_BANCO_ORIGEM'::text)) ORDER BY (round(sum(valor_transferencia)::numeric, 2)) DESC);
CREATE VIEW "bi"."vw_tesouraria_resumo_geral" TABLESPACE bi AS (SELECT date_trunc('month'::text, data)::date AS mes_referencia, round(sum(valor_transferencia)::numeric, 2) AS total_transferido, round(sum( CASE WHEN grupo_fluxo = 'tesouraria'::text THEN valor_transferencia ELSE 0::double precision END)::numeric, 2) AS total_tesouraria, round(sum( CASE WHEN grupo_fluxo = 'suprimento_caixa'::text THEN valor_transferencia ELSE 0::double precision END)::numeric, 2) AS total_suprimento, round(sum( CASE WHEN foi_conciliado IS TRUE THEN valor_transferencia ELSE 0::double precision END)::numeric, 2) AS total_conciliado, count(*) AS qtd_transferencias FROM bi.vw_tesouraria_transferencias GROUP BY (date_trunc('month'::text, data)::date) ORDER BY (date_trunc('month'::text, data)::date));
CREATE VIEW "bi"."vw_tesouraria_transferencias" TABLESPACE bi AS (SELECT t.id_transferencia, t.data, t.data_conciliacao, t.vencimento, t.banco_origem, t.agencia_orig, t.conta_origem, t.banco_destino, t.agencia_dest, t.conta_destino, t.valor_transferencia, t.numero_documento, t.historico, t.historico_limpo, t.id_convenio_orig, CASE WHEN co.nome_banco_limpo IS NOT NULL AND TRIM(BOTH FROM co.nome_banco_limpo) <> ''::text AND co.nome_banco_limpo <> 'None'::text THEN co.nome_banco_limpo WHEN t.banco_origem = '9999'::text THEN 'CAIXA'::text ELSE COALESCE(t.banco_origem, 'SEM_BANCO_ORIGEM'::text) END AS nome_banco_origem, COALESCE(co.conta_limpa, t.conta_origem, 'SEM_CONTA_ORIGEM'::text) AS conta_convenio_origem, t.id_convenio_dest, CASE WHEN cd.nome_banco_limpo IS NOT NULL AND TRIM(BOTH FROM cd.nome_banco_limpo) <> ''::text AND cd.nome_banco_limpo <> 'None'::text THEN cd.nome_banco_limpo ELSE COALESCE(t.banco_destino, 'SEM_BANCO_DESTINO'::text) END AS nome_banco_destino, COALESCE(cd.conta_limpa, t.conta_destino, 'SEM_CONTA_DESTINO'::text) AS conta_convenio_destino, t.id_lote_contabil, t.tipo, t.tipo_transferencia, t.tipo_lcto, t.grupo_fluxo, t.foi_conciliado, CASE WHEN t.foi_conciliado IS TRUE THEN 'conciliado'::text ELSE 'nao_conciliado'::text END AS status_conciliacao, t.etl_loaded_at FROM tb_fin_transferencias t LEFT JOIN tb_fin_convenios co ON t.id_convenio_orig = co.id_convenio LEFT JOIN tb_fin_convenios cd ON t.id_convenio_dest = cd.id_convenio WHERE t.data IS NOT NULL AND t.data >= '2024-01-01'::date AND t.data < '2031-01-01'::date);