...
/**
 * Visão de pendências movida para Gerencial > Operação.
...
export function BiOperacaoVisaoGeralDashboard() {
  ...
  if (!hasPermission('VIEW_DASHBOARD')) {
    return <WorkspaceNoAccess message="Seu perfil não possui acesso à Visão de pendências." />;
  }
  ...
  return (
    <div className="space-y-4">
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <h2 className="mt-1 text-xl font-bold text-slate-900">Visão de pendências</h2>
